<div {{ $attributes->merge(['class' => 'fixed flex mt-24 z-50 items-center w-full max-w-xs p-4 space-x-4 text-white divide-x rtl:divide-x-reverse divide-gray-200 rounded-lg shadow top-5 right-5 dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800']) }}
    role="alert">
