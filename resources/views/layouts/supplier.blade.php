...
<body x-data="themeSwitcher()" :class="{ 'dark': switchOn }">
    ...
    <aside :class="isOpen ? 'translate-x-0' : '-translate-x-full'" id="logo-sidebar"
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto">
            ...
            <ul>
                ...
                <x-nav-link-parent name="sectorGeneral" :active="request()->routeIs(['supplier.xml'])">
                    <i class="fa fa-cogs"></i>
                    General
                    <x-slot name="children">
                        <x-nav-link-child href="{{ route('supplier.companies') }}" :active="request()->routeIs('supplier.companies')">
                            Compañias
                        </x-nav-link-child>
                        <x-nav-link-child href="{{ route('supplier.xml') }}" :active="request()->routeIs('supplier.xml')">
                            Cargar xml de las ventas
                        </x-nav-link-child>
                    </x-slot>
                </x-nav-link-parent>
            </ul>
    ...
    <div class="p-4 sm:ml-64 pt-[72px] h-screen overflow-auto bg-slate-100 dark:bg-gray-700">
        ...
        <div class="p-4 sm:ml-64 absolute bottom-0 left-0 right-0 bg-white text-right">
            <p class="font-xs">Powered By Peru Dev Solutions E.I.R.L. +51 993187237</p>
        </div>
    </div>
